...
class RealTimeS2SAgent:
    ...
    def convert_text_to_speech(self, text: str) -> str:
        ...
        # THE DEFINITIVE FIX:
        # The .save_audio() method expects the raw model output tensor, not the decoded audio array.
        # This one line handles both the decoding and the saving correctly.
        self.tts_processor.save_audio(outputs, OUTPUT_WAV_FILE)
